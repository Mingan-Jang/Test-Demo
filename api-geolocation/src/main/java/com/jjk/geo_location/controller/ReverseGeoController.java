package com.jjk.geo_location.controller;
...
import com.jjk.geo_location.dto.ReqGeoDTO;
...
public class ReverseGeoController {
	...
	public ResponseEntity<String> reverseGeocode(ReqGeoDTO reqGeoDTO) {
	...
	public ResponseEntity<String> meow(ReqGeoDTO reqGeoDTO) {
		return null;
	}
}