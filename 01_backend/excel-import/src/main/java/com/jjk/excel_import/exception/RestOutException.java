...
@AllArgsConstructor
@Builder
public class RestOutException extends RuntimeException {
     ...
     */
    public RestOutException(String errorCode, String msg) {
        super(msg);
...
//    public RestOutException(HttpStatus httpstatus, String msg) {
//        super(msg);
...
//    }
     ...
     */
    public RestOutException(HttpStatus httpStatus, String errorCode, String msg, Throwable e) {
        super(msg, e);
        this.httpStatus = httpStatus;
        this.errorCode = errorCode;
    }
